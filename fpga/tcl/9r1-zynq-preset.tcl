proc getPresetInfo {} {
  return [dict create name {9r1_MPSoC_preset} description {9r1_MPSoC_preset}  vlnv xilinx.com:ip:zynq_ultra_ps_e:3.2 display_name {9r1_MPSoC_preset} ]
}
...
proc apply_preset {IPINST} {
  return [dict create \
    ...
    CONFIG.PSU__CRL_APB__SPI1_REF_CTRL__ACT_FREQMHZ {199.998000}  \
