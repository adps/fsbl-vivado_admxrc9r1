...
#
# simple-9r1.tcl: Tcl script for re-creating project 'simple-9r1'
#
# Generated by Vivado on Thu Jun 13 16:08:54 +0100 2019
...
#
# 1. This project restoration tcl script (simple-9r1.tcl) that was generated.
#
...
set _xil_proj_name_ "simple-9r1"
...
set script_file "simple-9r1.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/simple-9r1"]"

# Create project
create_project ${_xil_proj_name_} ./${_xil_proj_name_} -part xczu27dr-ffve1156-2-i
...
set_property -name "part" -value "xczu27dr-ffve1156-2-i" -objects $obj
...
set files [list \
 ...
 [file normalize "${origin_dir}/../vhdl/simple_9r1_wrapper.vhd"] \
]
...
set file "$origin_dir/../vhdl/simple_9r1_wrapper.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set obj [get_filesets sources_1]
set_property -name "top" -value "simple_9r1_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/../xdc/designs/9r1_simple/simple_9r1.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../xdc/designs/9r1_simple/simple_9r1.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj

# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/../xdc/boards/io_9r1.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../xdc/boards/io_9r1.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj

# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/../xdc/boards/clocks_9r1.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../xdc/boards/clocks_9r1.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
...
set obj [get_filesets constrs_1]
set_property -name "target_part" -value "xczu27dr-ffve1156-2-i" -objects $obj
...
if { [get_files nibble_swap.vhd] == "" } {
  import_files -quiet -fileset sources_1 f:/svn_repo/ch_repo/ZynqRFSoC/fsbl-vivado_admxrc9r1/fpga/vhdl/nibble_swap.vhd
}


# Proc to create BD simple_9r1
proc cr_bd_simple_9r1 { parentCell } {
...
proc create_hier_cell_ClockGeneration { parentCell nameHier } {
  ...
  # Create interface pins
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 fabric_clk
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net fabric_clk [get_bd_intf_pins fabric_clk] [get_bd_intf_pins util_ds_buf_0/CLK_IN_D]
  ...
  set fabric_clk [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 fabric_clk ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU_MIO_TREE_PERIPHERALS {Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash##Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#SD 0#SD 0#SD 0#SD 0#####SD 0#SD 0######UART 1#UART 1#UART 0#UART 0#SPI 1#PCIE##SPI 1#SPI 1#SPI 1#Gem 1#Gem 1#Gem 1#Gem 1#Gem 1#Gem 1#Gem 1#Gem 1#Gem 1#Gem 1#Gem 1#Gem 1#MDIO 1#MDIO 1#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#MDIO 3#MDIO 3} \
   CONFIG.PSU_MIO_TREE_SIGNALS {sclk_out#miso_mo1#mo2#mo3#mosi_mi0#n_ss_out##n_ss_out_upper#mo_upper[0]#mo_upper[1]#mo_upper[2]#mo_upper[3]#sclk_out_upper#sdio0_data_out[0]#sdio0_data_out[1]#sdio0_data_out[2]#sdio0_data_out[3]#####sdio0_cmd_out#sdio0_clk_out######txd#rxd#rxd#txd#sclk_out#reset_n##n_ss_out[0]#miso#mosi#rgmii_tx_clk#rgmii_txd[0]#rgmii_txd[1]#rgmii_txd[2]#rgmii_txd[3]#rgmii_tx_ctl#rgmii_rx_clk#rgmii_rxd[0]#rgmii_rxd[1]#rgmii_rxd[2]#rgmii_rxd[3]#rgmii_rx_ctl#gem1_mdc#gem1_mdio_out#ulpi_clk_in#ulpi_dir#ulpi_tx_data[2]#ulpi_nxt#ulpi_tx_data[0]#ulpi_tx_data[1]#ulpi_stp#ulpi_tx_data[3]#ulpi_tx_data[4]#ulpi_tx_data[5]#ulpi_tx_data[6]#ulpi_tx_data[7]#rgmii_tx_clk#rgmii_txd[0]#rgmii_txd[1]#rgmii_txd[2]#rgmii_txd[3]#rgmii_tx_ctl#rgmii_rx_clk#rgmii_rxd[0]#rgmii_rxd[1]#rgmii_rxd[2]#rgmii_rxd[3]#rgmii_rx_ctl#gem3_mdc#gem3_mdio_out} \
   ...
   CONFIG.PSU__CRL_APB__SPI0_REF_CTRL__ACT_FREQMHZ {177.776000} \
   ...
   CONFIG.PSU__DDRC__EN_2ND_CLK {1} \
  ...
  connect_bd_intf_net -intf_net fabric_clk [get_bd_intf_ports fabric_clk] [get_bd_intf_pins ClockGeneration/fabric_clk]
...
#  -string -flagsOSRD
preplace port fabric_clk -pg 1 -y 62 -defaultsOSRD
...
preplace netloc rst_util_ds_buf_1_100M_peripheral_aresetn 1 0 2 -10 260 600
preplace netloc fabric_clk 1 0 1 -50
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 2 -30 100 610
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_LPD 1 0 2 0 450 610
preplace netloc axi_smc_M00_AXI 1 0 2 -20 270 600
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 0 2 -40 460 600
levelinfo -pg 1 -70 300 630 -top -30 -bot 1090
"
}
...
# End of cr_bd_simple_9r1()
cr_bd_simple_9r1 ""
set_property REGISTERED_WITH_MANAGER "1" [get_files simple_9r1.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files simple_9r1.bd ] 

# Create 'synth_1' run (if not found)
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xczu27dr-ffve1156-2-i -flow {Vivado Synthesis 2017} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xczu27dr-ffve1156-2-i -flow {Vivado Implementation 2017} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
...
if { $obj != "" } {
set_property -name "display_name" -value "impl_1_post_route_phys_opt_r
eport_timing_summary_0" -objects $obj
